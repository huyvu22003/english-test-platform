...
| **C. Chẩn đoán** | Bản đồ điểm yếu theo kỹ năng/tag; lớp/cohort | 🔜 |
| **D. Placement tự chấm** | Reading/Listening/Use of English + engine `threshold` ra CEFR | 🔜 |
| **E. Ngân hàng câu hỏi** | tách `items` khỏi đề, import Excel, tái sử dụng | 🔜 |
| **F. Exit/Mock (high-stakes)** | phiên thi + mã thi + chống gian lận khi cần | 🔜 |
